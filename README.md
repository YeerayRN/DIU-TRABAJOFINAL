...
* **Navegación por teclado y Foco (WCAG 2.1.1 y 2.4.7):** Al intentar recorrer el catálogo y añadir productos al carrito utilizando exclusivamente la tecla `Tab`, resulta posible operar la web con normalidad. La propiedad CSS `:focus` visible permite saber en qué elemento de la pantalla se encuentra el usuario, habilitando la compra a personas con limitaciones motoras que no pueden usar el ratón.
